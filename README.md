# genpark-code-review-sandbox-runtime-execution-validator-skill
...
> **GenPark AI Agent Skill** -- Dynamic AST code review sandbox & runtime execution validator (Ito style)
